...
A repository dedicated to the studies and exercises completed during the *Python Certification* course at [freeCodeCamp].

## Progress
This repository is continuously updated as I progress through the [freeCodeCamp] *Python Certification*.

## Activities
The activities below are listed in the same order in which they
appear throughout the freeCodeCamp Python curriculum.

The table includes Workshops, Labs, and Certification Projects
as they are introduced in the course.

| ID | Type | Description | Section | Concepts | Status | Notes |
|---|---|---|---|---|---|---|
| [OFC-01] | Workshop | Build a Report Card Printer | Python Basics | Variables and Data Types | Completed | - |
...
### Workshops
Guided exercises used to practice the concepts covered during the course.

### Labs
Exercises in which the implementation is open, provided that the proposed
User Stories and requirements are met.

### Certification Projects
Larger projects developed throughout the certification program.



[freeCodeCamp]: https://www.freecodecamp.org/

[OFC-01]: ./Workshops/OFC-01.py
[OFC-02]: ./Workshops/OFC-02.py
[OFC-03]: ./Workshops/OFC-03.py
[OFC-04]: ./Workshops/OFC-04.py
[LAB-01]: ./Labs/LAB-01.py
